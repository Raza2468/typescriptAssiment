...
while (runStatment) {
    ...
    if (EnterAmount) {
        switch (currencyArr) {
            case "PKR" || "USD":
                console.log("PKR Convert to USD", EnterAmount * 0.0044);
                break;
            case "PKR" || "EURO":
                console.log("PKR Convert to EURO", EnterAmount * 241);
                break;
            case "USD" || "PKR":
                console.log("USD Convert to PKR", EnterAmount * 226);
                break;
            case "USD" || "EURO":
                console.log("USD Convert to EURO", EnterAmount * 241);
                break;
            case "EURO" || "PKR":
                console.log("USD Convert to PKR", EnterAmount * 0.0044);
                break;
            case "EURO" || "USD":
                console.log("USD Convert to PKR", EnterAmount * 226);
                break;
        ...
        let reltime = await inquirer.prompt([
            {
                type: "confirm",
                name: "reltimeConform",
